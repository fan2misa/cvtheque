 ...
 */
final class Version20181011120708 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(100) NOT NULL, avatar_path VARCHAR(255) DEFAULT NULL, situation_professionnelle LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', disponibilite LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', INDEX IDX_B66FFE92A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, informations_generales_id INT NOT NULL, entreprise_id INT DEFAULT NULL, cv_id INT NOT NULL, UNIQUE INDEX UNIQ_590C10395220281 (informations_generales_id), INDEX IDX_590C103A4AEAFEA (entreprise_id), INDEX IDX_590C103CFE419E2 (cv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
