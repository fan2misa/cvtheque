 ...
 */
final class Version20190614154336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, avatar_id INT DEFAULT NULL, user_id INT NOT NULL, theme_id INT DEFAULT NULL, nom VARCHAR(100) NOT NULL, situation_professionnelle ENUM(\'EN_POSTE\', \'EN_FIN_DE_CONTRAT\', \'EN_RECHERCHE_EMPLOI\', \'FREELANCE\', \'CONSULTANT\', \'ENTREPRENEUR\', \'PORTEUR_DE_PROJET\', \'ETUDIANT\', \'EN_FIN_ETUDE\', \'STAGIAIRE\', \'APPRENTI\', \'EN_ALTERNANCE\') DEFAULT NULL COMMENT \'(DC2Type:SituationProfessionnelleEnumType)\', disponibilite ENUM(\'RECHERCHE_ACTIVE\', \'RECHERCHE_STAGE\', \'SIMPLE_VEILLE\', \'OPPORTUNITE\', \'INDISPONIBLE\') DEFAULT NULL COMMENT \'(DC2Type:DisponibiliteEnumType)\', active TINYINT(1) NOT NULL, slug VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_B66FFE9286383B10 (avatar_id), INDEX IDX_B66FFE92A76ED395 (user_id), INDEX IDX_B66FFE9259027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, avatar_id INT DEFAULT NULL, nom VARCHAR(150) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, date_inscription DATETIME NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', enabled TINYINT(1) NOT NULL, token_inscription VARCHAR(255) DEFAULT NULL, date_anniversaire DATE DEFAULT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649989D9B62 (slug), UNIQUE INDEX UNIQ_8D93D64986383B10 (avatar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) NOT NULL, provider_name VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, size INT DEFAULT NULL, mime_type VARCHAR(100) DEFAULT NULL, width INT DEFAULT NULL, height INT DEFAULT NULL, context VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE theme (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, slug VARCHAR(150) NOT NULL, template_path VARCHAR(255) DEFAULT NULL, public_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cv ADD CONSTRAINT FK_B66FFE9286383B10 FOREIGN KEY (avatar_id) REFERENCES media (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv DROP FOREIGN KEY FK_B66FFE9286383B10');
