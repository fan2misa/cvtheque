 ...
 */
final class Version20181022170216 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nom VARCHAR(100) NOT NULL, avatar_path VARCHAR(255) DEFAULT NULL, situation_professionnelle ENUM(\'EN_POSTE\', \'EN_FIN_DE_CONTRAT\', \'EN_RECHERCHE_EMPLOI\', \'FREELANCE\', \'CONSULTANT\', \'ENTREPRENEUR\', \'PORTEUR_DE_PROJET\', \'ETUDIANT\', \'EN_FIN_ETUDE\', \'STAGIAIRE\', \'APPRENTI\', \'EN_ALTERNANCE\') DEFAULT NULL COMMENT \'(DC2Type:SituationProfessionnelleEnumType)\', disponibilite ENUM(\'RECHERCHE_ACTIVE\', \'RECHERCHE_STAGE\', \'SIMPLE_VEILLE\', \'OPPORTUNITE\', \'INDISPONIBLE\') DEFAULT NULL COMMENT \'(DC2Type:DisponibiliteEnumType)\', INDEX IDX_B66FFE92A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
